...
disponible, en cambio, no representa el caso de uso, por lo que la cifra de
descarte medida directamente sobre él (36,69\,\%) queda declarada \pend{} en
lugar de publicarse. Descomponiendo el corpus en sus regímenes de escena vacía y
escena activa se obtiene una estimación defendible para un local con actividad
intermitente: un descarte cercano al \dato{89\,\%}, que es lo que justifica la
